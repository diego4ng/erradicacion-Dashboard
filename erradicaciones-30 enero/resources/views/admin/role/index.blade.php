        ...
        <div class="box">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a href="{{route('create_role')}}" class="btn btn-block btn-success btn-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th class="text-center tableexport-ignore">
                                <a href="{{route('edit_role', ['id' => $data->id])}}" class="btn-accion-tabla tooltipsC" title="Editar este registro">
                                    <i class="fa fa-pencil fa-2x"></i>
                                </a>
                            </th>
                            <th class="text-center tableexport-ignore">
                                <form action="{{route('destroy_role', ['id' => $data->id])}}" class="d-inline form-eliminar" method="POST">
                                    @csrf @method("delete")
