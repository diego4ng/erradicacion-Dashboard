    ...
    <div class="col-lg-12">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Usuarios - Roles</h3>
                <div class="box-tools pull-right">
                    <a href="{{route('create_user_role')}}" class="btn btn-block btn-success btn-sm">
            ...
            <div class="box-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="align-middle">{{$data['usuario']['name']}}</td>
                            <td class="align-middle">{{$data['usuario']['email']}}</td>
                            ...
                            <th class="text-center tableexport-ignore">
                                <a href="{{route('edit_user_role', ['id' => $data['id']])}}" class="btn-accion-tabla tooltipsC" title="Editar este registro">
                                    <i class="fa fa-pencil fa-2x"></i>
                                </a>
                            </th>
                            <th class="text-center tableexport-ignore">
                                <form action="{{route('destroy_user_role', ['id' => $data['id']])}}" class="d-inline form-eliminar" method="POST">
                                    @csrf @method("delete")
